...
\begin{enumerate}
    \item \textbf{In the IR ($k^2 \ll M_*^2$):} The exponential $e^{-k^2/M_*^2} \approx 1$. The fractional term dominates, driving the dimensional reduction $d_S \to 2$ and generating the MOND phenomenology ($1/k^3$ scaling).
    \item \textbf{In the UV ($k^2 \gg M_*^2$):} The exponential term $e^{-k^2/M_*^2}$ suppresses the fractional operator faster than any polynomial growth. The action reduces exponentially to:
    \begin{equation}
